            ...
            <div class="span3 autoheight">
                <div class="footer-menu">
                    ...
                    <ul>
                        ...
                        @if(!empty($kontak->gp))
                        <li class="sosmed">
                            <a href="{{ url($kontak->gp) }}" target="_blank" title="Google+"><i class="fa fa-google-plus"></i></a>
                        </li>
                        @endif
                        @if(!empty($kontak->pt))
                        <li class="sosmed">
        ...
        <div class="row-fluid">
            ...
            <div class="span6">
                ...
                @if(count(list_veritrans()) > 0 && list_veritrans()->status == 1 && list_veritrans()->type == 1)
                    <img class="midtrans" src="{{url('img/bank/veritrans.png')}}" alt="Midtrans" title="Midtrans">
                @endif
                </p>
            </div>
        </div>
